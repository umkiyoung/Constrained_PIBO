...
# # #TODO: Add the ablation for the Reward Sampler
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=$seed python baselines/algorithms/pibo.py --task Rastrigin --dim 200 --batch_size 100\
#         --n_init 200 --seed $seed --max_evals 10000 --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
#         --buffer_size 1000 --alpha 1e-10 --beta 1e10 --local_search True --local_search_epochs 10 --diffusion_steps 30\
#         --gamma 1.0 --num_ensembles 5 --reweighting exp --filtering True --reward_sampler True --ablation RewardSampler&
# done
# wait
...
for alpha in 1e-6; do
    for seed in 0 1 2 3; do
        CUDA_VISIBLE_DEVICES=0 python baselines/algorithms/pibo.py --task Ackley --dim 200 --batch_size 100\
            --n_init 200 --seed $seed --max_evals 10000 --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
            --buffer_size 500 --alpha $alpha --local_search True --local_search_epochs 10 --diffusion_steps 30\
...
# for buffer_size in 200 1000 2000 5000 10000; do
#     for seed in 0 1 2 3; do
