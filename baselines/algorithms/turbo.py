...
if __name__ == "__main__":
    ...
    while True:
        ...
        save_len = len(X_turbo) // 1000 * 1000
        np.save(
            f"./baselines/results/turbo/turbo_{args.task}_{dim}_{args.seed}_{args.n_init}_{args.batch_size}_{args.max_evals}_{save_len}.npy",
            Y_turbo[:save_len].cpu().numpy(),
        )