...
if __name__ == "__main__":
    ...
    for round in range(num_rounds):
        ...
        save_len = (len(Y_numpy) // 1000) * 1000
        

        np.save(
            f"./baselines/results/diffbbo/diffbbo_{args.task}_{dim}_{args.seed}_{n_init}_{batch_size}_{args.max_evals}_{len(Y_numpy)}.npy",
            Y_numpy[:save_len],
        )
