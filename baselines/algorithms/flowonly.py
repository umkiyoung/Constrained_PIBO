...
from baselines.utils import save_numpy_array, set_seed
import wandb
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default="./baselines/algorithms/flowonly/")
    args = parser.parse_args()

    # wandb.init(project="flowonly",
    #            config=vars(args))
    ...
    for round in range(num_rounds):
        ...
        file_name = f"flowonly_{task}_{dim}_{seed}_{n_init}_{args.batch_size}_{args.buffer_size}_{args.num_ensembles}_{args.max_evals}_{save_len}.npy"
